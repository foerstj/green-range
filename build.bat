...
::for %%r in (longbourne-east longbourne-main longbourne-west longbourne-west-cellar) do (
...
rmdir /S /Q "%tmp%\Bits"
robocopy "%doc_dsloa%\Bits\art" "%tmp%\Bits\art" /E /xf .gitignore /xf *.psd /xf *.xcf
